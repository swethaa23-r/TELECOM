document.addEventListener('DOMContentLoaded', () => {
    ...
    // 3. Navbar Sticky Effect & Mobile Menu Logic (Optimized)
...
// 3D Vanilla Tilt Initialization
document.addEventListener('DOMContentLoaded', function() {
    if (typeof VanillaTilt !== 'undefined') {
        const tiltElements = document.querySelectorAll('.premium-card, .glass-card, .tilt-card, .pricing-card');
        
        tiltElements.forEach(el => {
            // Apply 3D perspective to parent
            el.style.transformStyle = 'preserve-3d';
            
            // Apply Z-translation to children so they pop out during tilt
